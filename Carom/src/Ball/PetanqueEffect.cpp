...
{
    entity_t _whiteBall = _handler->_myEntity->getScene().getEntitiesOfGroup(grp::WHITEBALL)[0];
    float distance = b2Distance(_handler->_myEntity->getTransform()->getPosition(), _whiteBall->getTransform()->getPosition());
