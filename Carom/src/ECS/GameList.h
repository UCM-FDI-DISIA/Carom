...
public:
	...
	bool empty() const
	{
		return ghostNode->next == &ghostNode;
	}
	...
	/// Iterador sobre los objetos de la lista
	...
	public:
		...
		iterator& operator=(const iterator& other)
		{
			...
			node = other.node;
			node->addref();
			// Elimina la referencia del nodo que se sobrescribe
			prev->unref();
		}

		/// Movimiento de un iterador (desactivado, que se copie)
