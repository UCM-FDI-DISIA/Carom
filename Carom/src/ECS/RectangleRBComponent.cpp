...
RectangleRBComponent::RectangleRBComponent(entity_t ent, const b2Vec2 &pos, b2BodyType type, float width, float height, float density, float friction , float restitution) : RigidBodyComponent(ent){
